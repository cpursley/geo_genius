...
SELECT geo_genius.put_area_name('demo_auth:city:CHILD', 'Springfield', 'official', NULL);
...
BEGIN
  FOR i IN 1..30 LOOP
    ...
    PERFORM geo_genius.put_area_name('demo_auth:city:NOISE' || i, 'Springfield', 'official', NULL);
...
SELECT geo_genius.put_area_code('demo_auth:city:CHILD', 'slug', 'springfield');
SELECT geo_genius.put_area_code('demo_auth:city:NOISE1', 'slug', 'springfield');
